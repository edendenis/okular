...
1. **Abrir o `Terminal Emulator`:** Você pode abrir o Terminal pressionando:
...
[1] OPENAI. ***Instalar o `okular` no `linux ubuntu` pelo `terminal emulator`.*** Disponível em: <https://chat.openai.com/c/a34dde21-da52-4dd3-853c-13861272bf34> (texto adaptado). Acessado em: 20/03/2023 17:11.
